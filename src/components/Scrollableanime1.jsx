        ...
        <div className="-mr-5 -ml-5 sm:-mr-11 sm:ml-0">
                <span className="relative max-w-none transition duration-500">
                  ...
                  <div className="relative lg:absolute lg:left-full w-full inset-y-0 py-16 lg:py-0 flex flex-col justify-center items-center">
                      <div className="absolute inset-0 shadow-sm dark:shadow-lg rounded-2xl bg-[url('https://replay.software/sleeve/images/SonomaWallpaperDark@2x.jpg')] dark:bg-[url('https://replay.software/sleeve/images/SonomaWallpaperDark@2x.jpg')] bg-cover bg-center">
                      </div>  
