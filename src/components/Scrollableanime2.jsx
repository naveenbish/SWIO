...
const Scrollableanime2 = () => {
  ...
  <img
    src="https://replay.software/sleeve/images/IconArrayTrackDark.png"alt="Iicon"width="86"height="86" className="w-86 h-86 mt-0" />
              ...
              <div className="flex flex-col lg:flex-col gap-6 lg:gap-10">
                  <p className="lg:max-w-[28ch]">Pick the track info you want to display, and then exactly how to display it.</p>
                  <p className="lg:max-w-[28ch]">Choose the fonts, weights, sizes, and transparency to use for each line, along with customizing color and shadow.</p>
              </div>
          </div>
          <div
              className="relative lg:absolute lg:left-full w-full inset-y-0 py-16 lg:py-0 flex flex-col justify-center items-center">
              <div className="lg:hidden absolute inset-0 shadow-outline dark:shadow-outline-bright rounded-2xl bg-[url('https://replay.software/sleeve/images/SonomaWallpaperDark@2x.jpg')] dark:bg-[url('https://replay.software/sleeve/images/SonomaWallpaperDark@2x.jpg')] bg-cover bg-center">
              </div>
  ...
  <span className="relative max-w-none transition duration-500">
    <img
      src="https://replay.software/sleeve/images/Typography1Dark.jpg"alt="Imageinterface1"width="330"height="234"className="w-330 h-234 rounded-xl" />
  </span>
</div>
<div className="relative flex transform-gpu">
  <span className="absolute inset-0 shadow-big dark:shadow-big-dark rounded-xl"></span>
