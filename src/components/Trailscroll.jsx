const Trailscroll = () => {
  return (
    <div className="flex flex-row ">
          <div className="relative flex flex-col lg:flex-row lg:justify-start items-center sm:items-start lg:py-40 text-lg md:text-2xl sm:text-left gap-12 lg:gap-0 lg:pl-11">
