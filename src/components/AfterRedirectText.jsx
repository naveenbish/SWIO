...
const AfterRedirectText = () => {
    return (
      ...
      <div
          ...
          <small
              className="inline-flex gap-2 font-semibold text-[#0D9EFF] dark:text-[#5DB7D2] uppercase tracking-wider mt-16">New in
              <span
                className="px-1.5 py-0.5 pb-px text-xs text-white dark:text-black bg-[#0D9EFF] dark:bg-[#5DB7D2] rounded-full">2.0
              </span>
          </small>
          <h2 className="text-3xl md:text-5xl font-bold mt-10">Themes.
              Unlimited themes
          </h2>
          <p className="text-lg md:text-2xl max-w-5xl">
